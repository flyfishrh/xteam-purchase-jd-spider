...
/**
 * Created by jianfengchen on 2017/8/30.
 */
...
//          System.out.println(bytesum);
   ...
   * 解压tar.gz文件
   */
//  public static void unTarFile(String filePath) {
//      try {
//          String outputPath = filePath.substring(0, filePath.indexOf('.'));
...
//                      new FileOutputStream(outputPath + File.separator + entry.getName(), false));
